...
# Originally categorized based on mean (skip)
...
# Second categorization based on median (skip)
...
# Categorized by mean of log-scale of charges (3 levels) (skip)
...
# Final Decision: Categorized by mean of log-scale of charges (2 levels)
med_ins2 <- med_ins2 %>% mutate(log_charge = log(charges))
mean_log_charges <- mean(med_ins2$log_charge)
...
# Log mean 2 levels: decision tree accuracy = 0.7662
